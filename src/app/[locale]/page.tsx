...
import { HomeIntentTracks } from "@/components/home/HomeIntentTracks";
...
export default async function HomePage({ params }: HomePageProps) {
  ...
  return (
    <main className="page-shell min-h-screen pb-28 text-[var(--foreground)] sm:pb-0">
      ...
      <HomeIntentTracks locale={locale} />

      <section id="luxury" className="luxury-panel luxury-shine py-12 text-white [content-visibility:auto] [contain-intrinsic-size:1px_760px]">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <p className="text-sm font-semibold uppercase tracking-[0.25em] text-[var(--brand-gold-300)]">
            {copy.shared.luxuryByRequest}
          </p>
          <h2 className="gold-shimmer-text font-display mt-3 max-w-3xl text-4xl font-semibold tracking-[-0.03em] sm:text-5xl">
          ...
          <div className="mt-8 grid gap-3 sm:flex">
            <Link
              ...
              className="luxury-shine inline-flex min-h-11 items-center justify-center rounded-[1.1rem] bg-[var(--brand-gold-100)] px-6 py-3 font-semibold text-[var(--surface-dark)] transition hover:bg-[var(--brand-gold-300)]"
            >
