...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: "https://sevilletoursco.com/contact-seville-tours-co/",
    },
    robots: {
      index: true,
      follow: true,
...
function formatInterest(interest?: string): string | undefined {
  ...
  switch (interest) {
    case "luxury":
      return "Luxury proposal";
    case "plan-trip":
      return "Plan trip request";
    case "gift-voucher":
      return "Gift voucher request";
    case "whatsapp":
      return "WhatsApp Carlos";
    default:
      return interest
        .split("-")
        .filter(Boolean)
...
function buildEnquiryTitle(
  tourName?: string,
  interestName?: string,
): string | undefined {
  if (tourName && interestName) {
    return `${interestName} for ${tourName}`;
  }
