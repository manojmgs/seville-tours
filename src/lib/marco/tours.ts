...
const MARCO_CATALOG: readonly MarcoCatalogEntry[] = [
  ...
  {
    id: "ronda",
    slug: "luxury-day-trip-from-seville-to-ronda-white-villages-private",
    name: "Ronda & the White Villages",
    badge: "Day Trip",
    emoji: "🏞️",
    duration: "Full day",
    desc: "A private day trip from Seville to Zahara de la Sierra, Ronda and Setenil de las Bodegas, at an unhurried pace.",
    tags: ["day trip", "history", "architecture", "nature", "luxury"],
...
async function buildTour(
  ...
  return {
    ...
    price: priceKnown
      ...
      : entry.fallbackPrice,
    priceSourceStatus: priceKnown ? "operator-published" : "confirmation-required",
    operatorUrl: manifest?.link,
    sourceUpdatedAt: manifest?.updatedAt,
    confirmationItems: entry.confirmationItems,
