...
export type SiteCopy = {
  ...
  home: {
    ...
    tracks: {
      ...
      intro: string;
      cards: {
        private: { badge: string; title: string; body: string; cta: string };
        luxury: { badge: string; title: string; body: string; cta: string };
        planner: { badge: string; title: string; body: string; cta: string };
      };
    };
    sections: {
      toursHeading: string;
  ...
  book: {
    ...
    experience: {
      ...
      direct: {
        ...
        giftEligibleNote: string;
        giftInvalidFormat: string;
        giftInactive: string;
        giftVerifyError: string;
        giftNote: string;
      };
    };
  };
