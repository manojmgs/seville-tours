...
export const enCopy: SiteCopy = {
  ...
  home: {
    ...
    tracks: {
      eyebrow: "Choose how you travel",
      heading: "Three ways to see Seville with us",
      intro:
        "Start private, go fully bespoke, or let Carlos shape the whole trip — every path is led by a licensed historian.",
      cards: {
        private: {
          badge: "Most booked",
          title: "Private guided tours",
          body: "Your own licensed historian for the Alcázar, Cathedral and the heart of Seville — at your pace, never in a crowd.",
          cta: "Browse private tours",
        },
        luxury: {
          badge: "By request",
          title: "Luxury & bespoke",
          body: "Chauffeured day trips, skip-the-line access and curated dining, arranged around your rhythm across Andalucía.",
          cta: "Request a proposal",
        },
        planner: {
          badge: "Not sure yet?",
          title: "Plan my trip",
          body: "Tell Carlos your dates, group and interests. We shape a private or luxury itinerary and send it straight to you.",
          cta: "Start planning",
        },
      },
    },
  ...
  book: {
    ...
    experience: {
      ...
      direct: {
        ...
        giftBalanceLabel: "Available balance",
        giftCodeMaskedLabel: "Code",
        giftEligibleNote:
          "This checks your gift card is valid. Final redemption happens only after we confirm your booking.",
        giftInvalidFormat: "Enter a valid gift card code and try again.",
        giftInactive:
          "This gift card is not active. The code may be incorrect, expired, or already redeemed.",
        giftVerifyError: "We couldn't check this gift card right now. Try again or contact us.",
