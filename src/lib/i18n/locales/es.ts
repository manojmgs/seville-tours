...
export const esCopy: SiteCopy = mergeCopy(enCopy, {
  ...
  home: {
    ...
    tracks: {
      eyebrow: "Elige cómo viajas",
      heading: "Tres formas de descubrir Sevilla con nosotros",
      intro:
        "Empieza en privado, hazlo totalmente a medida o deja que Carlos diseñe todo el viaje — cada camino guiado por un historiador con licencia.",
      cards: {
        private: {
          badge: "Lo más reservado",
          title: "Tours privados guiados",
          body: "Tu propio historiador con licencia para el Alcázar, la Catedral y el corazón de Sevilla — a tu ritmo, sin multitudes.",
          cta: "Ver tours privados",
        },
        luxury: {
          badge: "Bajo petición",
          title: "Lujo y a medida",
          body: "Excursiones con chófer, acceso sin colas y gastronomía seleccionada, organizado a tu ritmo por toda Andalucía.",
          cta: "Solicitar propuesta",
        },
        planner: {
          badge: "¿Aún no lo tienes claro?",
          title: "Planificar mi viaje",
          body: "Cuéntale a Carlos tus fechas, grupo e intereses. Diseñamos un itinerario privado o de lujo y te lo enviamos.",
    ...
    gift: {
      ...
      fixedTitle: "Tarjeta regalo — Visita guiada al Alcázar",
      fixedDescription: "Regala la visita guiada en grupo reducido al Real Alcázar, con un historiador con licencia oficial.",
      fixedSkus: [
  ...
  book: {
    ...
    experience: {
      ...
      liveNote: "En directo desde FareHarbor — fechas y precios sujetos a confirmación.",
      loading: "Cargando disponibilidad en directo…",
      noDates: "No hay fechas en directo ahora mismo. Escríbenos y organizamos una fecha para ti.",
      selectDate: "Elige una fecha",
      selectTime: "Elige una hora",
      chooseDateHint: "Elige una fecha para ver las horas disponibles.",
      loadingTimes: "Cargando horas…",
      noTimesForDate: "No hay horas este día. Prueba con otra fecha.",
      ...
      checkingSpots: "Comprobando disponibilidad en directo…",
      soldOut: "Agotado — escríbenos para la próxima fecha.",
      guests: "Viajeros",
      perPerson: "por persona",
      free: "Gratis",
      from: "desde",
      estimatedTotal: "Total estimado",
      totalNote: "El precio final y la disponibilidad se confirman antes de cualquier pago.",
      feeNote: "El pago en FareHarbor añade una pequeña tarifa de reserva. Reservando directamente con nosotros la evitas.",
      selectPrompt: "Elige una fecha y una hora para continuar.",
      bookDirect: "Reservar directamente con nosotros",
      bookDirectHint: "Paga con Bizum, efectivo, transferencia o canjea una tarjeta regalo. Carlos lo confirma personalmente.",
      bookFareharbor: "Reservar y pagar en FareHarbor",
      bookFareharborHint: "Pago con tarjeta al instante en la página segura de FareHarbor.",
      buyGift: "Comprar una tarjeta regalo",
      buyGiftHint: "Se compra en ParaUsted y es canjeable por este tour.",
      direct: {
        title: "Solicita tu reserva",
        intro: "Dinos quién viene. Carlos confirma tu hora y te envía los datos de pago por WhatsApp.",
        paymentLabel: "Pago preferido",
        paymentBizum: "Bizum",
        paymentCash: "Efectivo",
        paymentBank: "Transferencia bancaria",
        paymentGift: "Canjear tarjeta regalo",
        paxHeading: "Datos de los viajeros",
        paxName: "Nombre completo",
        paxId: "DNI / N.º de pasaporte",
        paxIdNote: "Exigido por el monumento para la entrada.",
        leadName: "Tu nombre",
        leadContact: "WhatsApp o email",
        notes: "¿Algo más?",
        notesPlaceholder: "Necesidades de acceso, idioma, peticiones especiales…",
        consent: "Al enviar, aceptas que usemos estos datos para gestionar y confirmar tu reserva.",
        submit: "Enviar solicitud por WhatsApp",
        back: "Volver",
        payHeading: "Cómo pagar",
        bizumLabel: "Envía el Bizum a",
        bankHolderLabel: "Titular de la cuenta",
        bankIbanLabel: "IBAN",
        bankBicLabel: "BIC / SWIFT",
        cashNote: "Paga a Carlos en efectivo al encontrarte con tu guía. Sin depósito.",
        proofLabel: "Referencia de pago (opcional)",
        proofPlaceholder: "p. ej. Bizum enviado 12:40, o referencia de la transferencia",
        proofNote: "Tras enviar la solicitud, adjunta el justificante de pago por WhatsApp para que Carlos lo confirme antes.",
        giftHeading: "Canjea tu tarjeta regalo",
        giftCodeLabel: "Código de la tarjeta regalo",
        giftCodePlaceholder: "p. ej. GIFT-1A2B3C",
        giftRedeem: "Verificar código",
        giftChecking: "Comprobando con ParaUsted…",
        giftVerified: "Tarjeta regalo verificada",
        giftBalanceLabel: "Saldo disponible",
        giftCodeMaskedLabel: "Código",
        giftEligibleNote:
          "Esto comprueba que tu tarjeta regalo es válida. El canje final solo se realiza cuando confirmamos tu reserva.",
        giftInvalidFormat: "Introduce un código de tarjeta regalo válido e inténtalo de nuevo.",
        giftInactive:
          "Esta tarjeta regalo no está activa. El código puede ser incorrecto, haber caducado o ya haberse canjeado.",
        giftVerifyError:
          "No pudimos comprobar esta tarjeta regalo ahora. Inténtalo de nuevo o contáctanos.",
        giftNote: "Las tarjetas regalo las emite y verifica ParaUsted.",
      },
    },
  },
  wordpress: {
