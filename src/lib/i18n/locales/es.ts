  ...
  book: {
    ...
    experience: {
      ...
      direct: {
        ...
        giftPending: "Código recibido. Carlos lo verificará con ParaUsted y confirmará tu reserva.",
        giftInvalid: "Ese código no parece correcto. Revísalo e inténtalo de nuevo.",
        giftUnavailable: "La verificación no está disponible ahora. Lo confirmaremos manualmente.",
        giftVerified: "Tarjeta regalo verificada.",
        giftNote: "Las tarjetas regalo las emite y verifica ParaUsted.",
        giftRedeemedHeading: "Tarjeta regalo canjeada",
        giftAmountLabel: "Importe canjeado",
        giftBalanceLabel: "Saldo restante",
        giftCodeMaskedLabel: "Código",
        giftRedeemErrors: {
          unauthorized: "No pudimos verificar esta tarjeta regalo ahora. Lo confirmaremos manualmente.",
          forbidden: "Esta tarjeta regalo no puede canjearse aquí. Contáctanos, por favor.",
          rate_limited: "Demasiados intentos. Espera un momento e inténtalo de nuevo.",
          invalid_code: "Ese código no parece correcto. Revísalo e inténtalo de nuevo.",
          invalid_request: "No pudimos procesar la solicitud. Revísalo e inténtalo de nuevo.",
          not_found: "No encontramos ninguna tarjeta regalo con ese código.",
          already_redeemed: "Esta tarjeta regalo ya se ha canjeado.",
          expired: "Esta tarjeta regalo ha caducado.",
          voided: "Esta tarjeta regalo ya no es válida.",
          exchanged: "Esta tarjeta regalo ya se ha cambiado.",
          not_redeemable: "Esta tarjeta regalo no puede canjearse.",
          already_processed: "Este canje ya se había procesado.",
          unknown: "Algo salió mal. Confirmaremos tu tarjeta regalo manualmente.",
        },
      },
    },
  },
