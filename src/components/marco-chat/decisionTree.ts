 ...
 */
export function recommend({ duration, interest, group }: MarcoAnswers): RecommendationResult {
  if (interest === "daytrip") {
    return {
  ...
  if (interest === "food") {
    return {
      tourIds: ["tapas", "highlights"],
      reasonCode: "food-interest",
      usedInputs: ["interest"],
    };
  }
  if (duration === "few-hours") {
    return {
  ...
  if (group === "family") {
    return {
      tourIds: ["highlights", "alcazar"],
      reasonCode: "family-context",
      usedInputs: ["group"],
    };
  }
  if (interest === "history") {
    return {
      tourIds: ["alcazar", "cathedral"],
      reasonCode: "history-interest",
      usedInputs: ["interest"],
    };
  }
  return {
    tourIds: ["highlights", "alcazar"],
    reasonCode: "general-introduction",
    usedInputs: [],
  };
}
